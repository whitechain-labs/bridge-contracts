...
export const PRIVATE_KEY_ACC_0: string = '';
export const PRIVATE_KEY_ACC_1: string = '';
export const PRIVATE_KEY_ACC_2: string = '';
export const PRIVATE_KEY_ACC_3: string = '';
export const PRIVATE_KEY_ACC_4: string = '';
export const PRIVATE_KEY_ACC_5: string = '';
